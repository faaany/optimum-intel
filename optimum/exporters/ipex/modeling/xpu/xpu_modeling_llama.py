...
class _IPEXLlamaAttentionXPU(_IPEXLlamaAttention):
    ...
    def port_parameters(self, module):
        ...
        if self.num_heads == self.num_kv_heads:
            ...
            module.q_proj.data = self.qkv_proj_weight[:, :group, :, :].view([self.num_kv_heads * group * self.head_dim, self.embed_dim])
            module.k_proj.data = self.qkv_proj_weight[:, group, :, :].view([self.num_kv_heads * self.head_dim, self.embed_dim])
